...
from hipercic.hipercore.admin.util import flatten_fieldsets, lookup_field
from hipercic.hipercore.admin.util import display_for_field, label_for_field
...
class AdminReadonlyField(object):
    ...
    def contents(self):
        from hipercic.hipercore.admin.templatetags.admin_list import _boolean_icon
        from hipercic.hipercore.admin.views.main import EMPTY_CHANGELIST_VALUE
