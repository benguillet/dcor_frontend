...
from django.forms.models import (BaseModelForm, BaseModelFormSet, fields_for_model,
    _get_foreign_key)
from hipercic.hipercore.admin.options import flatten_fieldsets, BaseModelAdmin
from hipercic.hipercore.admin.options import HORIZONTAL, VERTICAL
from hipercic.hipercore.admin.util import lookup_field
                ...
                if not hasattr(cls, field):
                    if not hasattr(model, field):
                        ...
                        if isinstance(f, models.ManyToManyField):
                            # TODO this should parse the information and put it as a list to be displayed with new lines
