...
from hipercic.hipercore.authenticore.models import User, AnonymousUser
...
class BasicTestCase(TestCase):
    def test_user(self):
        ...
        self.assertFalse(u.is_app_manager)
    ...
    def test_superuser(self):
        ...
        self.assertTrue(super.is_admin)
        self.assertTrue(super.is_active)
        self.assertTrue(super.is_app_manager)
