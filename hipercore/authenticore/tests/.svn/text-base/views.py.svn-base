...
from hipercic.hipercore.authenticore import SESSION_KEY, REDIRECT_FIELD_NAME
...
class LoginTest(AuthViewsTestCase):
    ...
    def test_current_site_in_context_after_login(self):
        response = self.client.get(reverse('hipercic.hipercore.authenticore\.views.login'))
        self.assertEquals(response.status_code, 200)
    ...
    def test_security_check(self, password='password'):
        login_url = reverse('hipercic.hipercore.authenticore\.views.login')
