...
from hipercic.hipercore.authenticore.models import User, Group, Permission, AnonymousUser
...
class BackendTest(TestCase):
    ...
    backend = 'hipercic.hipercore.authenticore\.backends.ModelBackend'
    ...
    def test_has_perm(self):
        ...
        self.assertEqual(user.has_perm('authenticore\.test'), False)
        user.is_staff = True
        user.save()
        self.assertEqual(user.has_perm('authenticore\.test'), False)
    ...
    def test_has_no_object_perm(self):
        ...
        self.assertEqual(user.has_perm('authenticore\.test', 'object'), False)
        self.assertEqual(user.get_all_permissions('object'), set([]))
        self.assertEqual(user.has_perm('authenticore\.test'), True)
        self.assertEqual(user.get_all_permissions(), set(['authenticore\.test']))
...
class RowlevelBackendTest(TestCase):
    """
    Tests for authenticore backend that supports object level permissions
    """
    backend = 'hipercic.hipercore.authenticore\.tests.auth_backends.SimpleRowlevelBackend'
...
class AnonymousUserBackendTest(TestCase):
    ...
    backend = 'hipercic.hipercore.authenticore\.tests.auth_backends.AnonymousUserBackend'
...
class NoBackendsTest(TestCase):
    """
    Tests that an appropriate error is raised if no authenticore backends are provided.
    """
    def setUp(self):
