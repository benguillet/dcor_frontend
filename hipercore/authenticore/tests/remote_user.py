...
from hipercic.hipercore.authenticore.backends import RemoteUserBackend
...
class RemoteUserTest(TestCase):
    ...
    urls = 'hipercic.hipercore.authenticore\.tests.urls'
    middleware = 'hipercic.hipercore.authenticore\.middleware.RemoteUserMiddleware'
    backend = 'hipercic.hipercore.authenticore\.backends.RemoteUserBackend'
...
class RemoteUserNoCreateTest(RemoteUserTest):
    """
    Contains the same tests as RemoteUserTest, but using a custom authenticore backend
    class that doesn't create unknown users.
    """

    backend =\
        'hipercic.hipercore.authenticore\.tests.remote_user.RemoteUserNoCreateBackend'
...
class RemoteUserCustomTest(RemoteUserTest):
    ...
    backend =\
        'hipercic.hipercore.authenticore\.tests.remote_user.CustomRemoteUserBackend'
